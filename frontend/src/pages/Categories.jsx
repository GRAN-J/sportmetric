  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-on-surface-variant font-bold">Cargando categorías...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="space-y-4 rounded-3xl border border-error/20 bg-error-container/10 p-8">
        <h1 className="text-2xl font-bold text-primary">No fue posible cargar las categorías</h1>
